...
public class VoitureController {
    ...
    public ResponseEntity<Object> findById(@PathVariable Long id) {
        try {
            ...
            voiture.setClient(clientService.clientByIdAlternative(voiture.getId_client()));
    ...
    public ResponseEntity<List<Voiture>> findByClient(@PathVariable Long id) {
        try {
            Client client = clientService.clientByIdAlternative(id);
            if (client != null) {
    ...
    public ResponseEntity<Object> save(@PathVariable Long clientId, @RequestBody Voiture voiture) {
        try {
            Client client = clientService.clientByIdAlternative(clientId);
